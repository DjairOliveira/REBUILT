...
public class SwerveSubsystem extends SubsystemBase
{
  ...
  public void periodic()
  {
    ...
    double latencySeconds = limelightPose.latency / 1000.0; // ms → s
    double visionTimestamp = Timer.getFPGATimestamp() - latencySeconds;

    if (limelightPose != null && limelightPose.tagCount > 0) {
      getSwerveDrive().addVisionMeasurement(limelightPose.pose, visionTimestamp);
    }

    //SmartDashboard.putNumber("DistToTarget", swerveDrive.getPose().getTranslation().getDistance(targetPose.getTranslation()));
  }
