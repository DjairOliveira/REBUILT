...
public class ElevadorSim extends SubsystemBase {
    ...
    private double subIntakeAngle = 0.0;
    private double subShooterAngle = 0.0;
    ...
    public void setSubShooter(double angle) {
        subShooterAngle = angle;
    }

    public void setSubIntake(double angle) {
        subIntakeAngle = angle;
    }

    public void setSubGaveta(double position) {
        subGavetaPositon = position;
    }

    public void setSubClimber(double position) {
        subClimberPositon = position;
    }
    ...
    public void simulationPeriodic() {
        ...
        Logger.recordOutput("SubSystemIntake", new Pose3d[] {new Pose3d(
            0.355, 0, 0.179, new Rotation3d(0.0, Math.toRadians(subIntakeAngle), 0))});

        Logger.recordOutput("SubSystemGaveta", new Pose3d[] {new Pose3d(
            0.067 + subGavetaPositon, 0, 0.179, new Rotation3d(0.0, 0, 0))});

        Logger.recordOutput("SubSystemClimber", new Pose3d[] {new Pose3d(
           0.356, 0, subClimberPositon, new Rotation3d(0.0, 0, 0))});
